...
def solver(nx,ny,tau,parameter, epsilon, dt, T,w):
  ...
  # Save the values generated by the solvers
  vtkfile = File('Alixcode/presentation/solution_solver_constantdt.pvd')
...
def solver_ada(nx,ny,tau,parameter, epsilon, dt_list, T,w):
    ...
    # Save the values generated by the solvers
  vtkfile = File('Alixcode/presentation/solution_solver_adaptive_dt.pvd')
