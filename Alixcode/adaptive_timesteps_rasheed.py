...
def exponential_time_double_glazingA(parameter,
                                    tau,
                                    epsilon = 1/200,
...
#   dt = 1 / num_steps # time step size
  ...
  while t<T:
      ...
      t_list.append(t) #get a list of the values of time
  ...
  if plot_u_t==True:
      ...
      ax[0].plot(t_list, np.log(dt_list))
      ax[0].set_xlabel('$t$')
      ax[0].set_ylabel('$dt$')
  ...
  return u_list, t_list, dt_list


# u_list, res, dt_list= exponential_time_double_glazingA(1,
