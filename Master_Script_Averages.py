'''
Script that complies all three MCMC sampling techniques into one function for testing.
'''
...
from Master_RWMH_Averages import *
from Master_Delayed_Acceptance_Averages import *
from Master_Irreversible_RWMH_Averages import *
...
def main():
    ...
    # RWMH parameters.
    iterations = 100                       # Number of samples to generate (-burnin).
    ...
    with open(f'Master/Noisy_Data/data_32_thisistheoneweareusing!!!_it _noisy_averaged', 'rb') as file:
        y = pickle.load(file)
    
    # Open low resolution data file.
    with open(f'Master/Noisy_Data/data_16_averaged', 'rb') as file:
    ...
    with open(f'/home/s1634937/Documents/Project 2/PhD-project2/Master/Sleepy_Data_Av_2/alpha_list_RWMH_time{time_RWMH}', 'wb') as file:
        pickle.dump(alpha_list_RWMH, file)
    with open(f'/home/s1634937/Documents/Project 2/PhD-project2/Master/Sleepy_Data_Av_2/ratio_list_RWMH', 'wb') as file:
    ...
    with open(f'/home/s1634937/Documents/Project 2/PhD-project2/Master/Sleepy_Data_Av_2/alpha_list_DA_time{time_DA}', 'wb') as file:
        pickle.dump(alpha_list_DA, file)
    with open(f'/home/s1634937/Documents/Project 2/PhD-project2/Master/Sleepy_Data_Av_2/ratio_list_DA', 'wb') as file:
        pickle.dump(ratio_list_DA, file)
    with open(f'/home/s1634937/Documents/Project 2/PhD-project2/Master/Sleepy_Data_Av_2/reject_first_list_DA', 'wb') as file:
    ...
    with open(f'/home/s1634937/Documents/Project 2/PhD-project2/Master/Sleepy_Data_Av_2/alpha_list_IRWMH_time{time_IRWMH}', 'wb') as file:
        pickle.dump(alpha_list_IRWMH, file)
    with open(f'/home/s1634937/Documents/Project 2/PhD-project2/Master/Sleepy_Data_Av_2/ratio_list_IRWMH', 'wb') as file:
