...
if __name__ == "__main__":
    ...
    def main():
        ...
        alpha = 0.1 #0.1 * 1/np.pi                         # alpha parameter used in gamma proposal (different to wind-speed variable).
        beta = 0.01 #np.sqrt(2/np.pi)                 # beta parameter used in gamma proposal.
        ...
        with open('Master/Noisy_Data/INTERPOLATION_data_32_THIS_ONE!!', 'rb') as file:
             y = pickle.load(file)
