'''
Script to numerically integrate the prior-likelihood function to obtain the marginal likelihood Z.
'''
...
if __name__ == "__main__":
    ...
    def main():
        ...
        B = 3.28625e4                           # Pertubation constant to artificially scale function.
        ...
        # Load data file.
        with open('Master/Data_eps100_num150000_tau10_alpha0/master_data_16_project', 'rb') as file:
        ...
        return PL_list, PL_int_list, bins, K

    PL_list, PL_int_list, bins, K = main()
