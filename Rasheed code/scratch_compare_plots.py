...
chain_data = [(np.load('var_metropolis.npy'), load_data('alpha_list_RWMH')),
            (np.load('var_delayed_MCMC.npy'), load_data('alpha_list_DA')),
            (np.load('var_gamma_nonreversible_MCMC.npy'), load_data('alpha_list_IRWMH'))]

acceptance_ratio_data = [(np.load('var_metropolis_accept_ratio.npy'), load_data('A_list_RWMH')),
                        (np.load('var_delayed_MCMC_accept_ratio.npy'), load_data('A_list_DA')),
                        (np.load('var_gamma_nonreversible_MCMC_accept_ratio.npy'), load_data('A_list_IRWMH'))]
